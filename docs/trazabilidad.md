...
|----|-------------|------|--------|--------|--------|
| CU-1.1.1 | Inicializar proyecto Node.js + Express | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.1.2 | Configurar Sequelize + MySQL | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.1.3 | Configurar motor EJS | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.1.4 | Configurar middlewares base | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.2.1 | Estructura del proyecto frontend (HTML/CSS/JS vanilla) | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.2.2 | Branding global (logo, favicon, nombres) | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-1.2.3 | Sistema de temas claro/oscuro | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-1.2.4 | Barra de navegación persistente | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-1.3.1 | Dockerfile del backend | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.3.2 | Dockerfile del frontend (nginx) | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.3.3 | docker-compose.yml con mysql + backend + frontend | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-1.3.4 | Variables de entorno y `.env.example` | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.1 | Modelo Categoria | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.2 | Modelo Producto | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.3 | Modelo Usuario | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.4 | Modelo Venta | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.5 | Modelo VentaProducto | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.1.6 | Modelo Encuesta | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-2.1.7 | Modelo LogLogin | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-2.2.1 | Seed de categorías | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.2.2 | Seed de productos | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-2.2.3 | Seed de admin de prueba | 🎯 | 1 | Pendiente | `[completar-link]` |
| CU-3.1.1 | Listar productos paginados | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.1.2 | Obtener producto por ID | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.1.3 | Listar categorías | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.2.1 | Alta de producto con imagen | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.2.2 | Modificación de producto | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.2.3 | Baja lógica de producto | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.2.4 | Reactivación de producto | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.3.1 | Middleware validación de productos | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-3.3.2 | Middleware validación de imagen | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.1.1 | Endpoint registro de admin | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.2.1 | Login vía API | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.2.2 | Login vía vista EJS | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.2.3 | Botón de acceso rápido | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.2.4 | Middleware de autenticación | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-4.2.5 | Logout | 🎯 | 2 | Pendiente | `[completar-link]` |
| CU-5.1.1 | Pantalla bienvenida con nombre | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.1 | Visualización por categorías | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.2 | Paginación de productos | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.3 | Diseño responsive | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.4 | Agregar producto al carrito | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.5 | Quitar producto desde productos | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.2.6 | Indicador de items en carrito | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.3.1 | Listado de productos en carrito | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.3.2 | Modificar cantidades en carrito | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.3.3 | Eliminar producto del carrito | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.3.4 | Modal de confirmación de compra | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.3.5 | POST de venta al backend | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.4.1 | Mostrar ticket | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.4.2 | Descargar ticket en PDF | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-5.4.3 | Botón reiniciar (autoservicio) | 🎯 | 3 | Pendiente | `[completar-link]` |
| CU-6.1.1 | Dashboard listado de productos | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.1.2 | Acciones por producto en dashboard | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.1.3 | Botón agregar producto | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.1.4 | Botón descargar ventas Excel | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.1.5 | Botón ver registros | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-6.2.1 | Pantalla alta de producto | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.2.2 | Pantalla edición (reutiliza alta) | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-6.2.3 | Modales de confirmación baja/alta | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-7.1.1 | Generar Excel de ventas | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-7.1.2 | API listado de ventas con productos | 🎯 | 4 | Pendiente | `[completar-link]` |
| CU-7.2.1 | Generar Excel de encuestas | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.1 | Redirigir desde ticket a encuesta | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.2 | Formulario 5 tipos de input | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.3 | Validaciones de encuesta | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.4 | Upload imagen de encuesta | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.5 | Botón omitir encuesta | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.1.6 | Modal agradecimiento | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.2.1 | Ruta detalle de producto | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-8.2.2 | Agregar al carrito desde detalle | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.1.1 | Registrar intentos de login | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.1.2 | Vista de logs en panel | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.2.1 | Top 10 productos más vendidos | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.2.2 | Top 10 ventas más caras | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.2.3 | Estadística extra ventas por categoría | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-9.2.4 | Estadística extra puntuación promedio | ⭐ | 5 | Pendiente | `[completar-link]` |
| CU-10.1.1 | Diseño responsive en todas pantallas | 🎯 | 5 | Pendiente | `[completar-link]` |
| CU-10.1.2 | Criterio estético consistente | 🎯 | 5 | Pendiente | `[completar-link]` |
| CU-10.2.1 | README de cada repo | 🔧 | 5 | Pendiente | `[completar-link]` |
| CU-10.2.2 | Colección de Postman | 🔧 | 5 | Pendiente | `[completar-link]` |
| CU-10.3.1 | Repositorios separados | 🔧 | 1 | Pendiente | `[completar-link]` |
| CU-10.3.2 | Commits balanceados | 🔧 | continuo | Pendiente | `[completar-link]` |
| CU-10.3.3 | Branching y PRs | 🔧 | continuo | Pendiente | `[completar-link]` |
...
## CU-7.2.1 — Generar Excel de encuestas ⭐
...
# ÉPICA 8: Encuestas y detalle (final) ⭐

## CU-8.1.1 — Redirigir desde ticket a encuesta ⭐
...
## CU-8.1.3 — Validaciones de encuesta ⭐
...
## CU-8.1.4 — Upload imagen de encuesta ⭐
...
## CU-8.1.5 — Botón omitir encuesta ⭐
...
## CU-8.2.1 — Pantalla de detalle de producto por query string ⭐
...
## CU-8.2.2 — Agregar al carrito desde detalle ⭐
...
# ÉPICA 9: Registros y estadísticas (final) ⭐

## CU-9.1.1 — Registrar intentos de login ⭐
...
## CU-9.1.2 — Vista de logs en panel ⭐
...
## CU-9.2.3 — Estadística extra: ventas por categoría ⭐
...
## CU-9.2.4 — Estadística extra: puntuación promedio ⭐
